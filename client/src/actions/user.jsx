...
export const register=async(user,dispatch)=>{
    ...
    if(result){
        ...
        dispatch({type:'UPDATE_ALERT',payload:{open:true,severity:'success',message:'Created successfully'}})
...
export const updateProfile = async (currentUser, updatedFields, dispatch) => {
    ...
    try {
      ...
      if (result) {
        ...
        dispatch({ type: 'UPDATE_ALERT', payload: { open: true, severity: 'success', message: 'Updated successfully' } });
